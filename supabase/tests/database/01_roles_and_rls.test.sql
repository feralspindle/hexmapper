...
insert into public.import_keys (session_id, created_by, name, key_hash, key_prefix)
values ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'my-familiar', 'fixturehash', 'hxm_fixt');

insert into public.compendium_entries (session_id, created_by, kind, name, data)
values ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'gear', 'Rope', '{"cost":"5 sp"}');
