...
const COLS: &str = "id, session_id, name, map_type, map_image_path, map_hex_width, map_hex_height, map_image_rotation, map_grid_rotation, map_image_offset_x, map_image_offset_y, map_grid_offset_x, map_grid_offset_y, map_offset_locked, created_at, fog_reveal_all, map_scale, map_scale_unit, map_image_scale, parent_map_id, parent_hex_id, party_hex_q, party_hex_r";
