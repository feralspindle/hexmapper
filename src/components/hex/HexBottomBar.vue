    ...
    <template v-if="activeTool === 'paint'">
      ...
      >
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" :stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="hm-stamp-glyph">
          ...
          <template v-else-if="t.id === 'jungle'">
          ...
          <template v-else-if="t.id === 'coast'">
            <path d="M20 3c-1 7-6 12-14 15"/>
            <path d="M3 10c2-1.5 4 1.5 6 0M3 15c1.5-1.5 3 1.5 4.5 0"/>
            <circle cx="17" cy="13" r="0.9" fill="currentColor" stroke="none" opacity="0.7"/>
            <circle cx="14" cy="18" r="0.9" fill="currentColor" stroke="none" opacity="0.7"/>
            <circle cx="19" cy="18" r="0.9" fill="currentColor" stroke="none" opacity="0.7"/>
          </template>
